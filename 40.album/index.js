...
// number of tracks, add that value to the album’s Object. Make at least one new function 
...
const album1 = make_album('artist 1', 'album tital 1');
console.log(album1);
const album2 = make_album('artist 2', 'album tital 2');
console.log(album2);
const album3 = make_album('artist 3', 'album tital 3, 12');
console.log(album3);
